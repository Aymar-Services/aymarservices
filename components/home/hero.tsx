    ...
    },
    {
      ...
      logo: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
          ...
          <path d="M12 8.5c-3.5 0-6.5.7-8.5 1.8-1.2.6-2 1.5-2 2.2s.8 1.6 2 2.2c2 1.1 5 1.8 8.5 1.8s6.5-.7 8.5-1.8c1.2-.6 2-1.3 2-2.2s-.8-1.6-2-2.2c-2-1.1-5-1.8-8.5-1.8zm0-6c1.8 0 3.3.9 4.3 2.5.6 1 .9 2.1.9 3.3 0 1-.2 2-.5 3-2-1-4.3-1.5-6.7-1.5s-4.7.5-6.7 1.5c-.3-1-.5-2-.5-3 0-1.2.3-2.3.9-3.3-1 1.6-2.5 2.5-4.3 2.5z" />
        </svg>
      ),
      color: "text-cyan-400",
    },
